...
<head>
    ...
    <style>
        ...
        .details th, .details td {
            ...
            border: inset 2px #360d29;
        }
        .details th {
            background-color: #bde8e6b5;
            text-align: center;
        }
        .button-container {
            text-align: center;
...
<h1 class="tfd">Training Form Details</h1>
<div class="container">
    <div class="details">
        <table>
            <tr>
            ...
            <?php if (!empty($training['notice'])) : ?>
                <tr>
                    ...
                    <td><a href="download_notice.php?training_id=<?php echo $training['id']; ?>">Download</a></td>
                </tr>
            <?php endif; ?>
        </table>
    </div>
