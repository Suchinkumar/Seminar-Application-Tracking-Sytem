...
<body>
    ...
    <h2 class="color">Feedback Forms</h2>
    
    <h3 class="color1">Pending Forms</h3>
    <?php
    $has_pending_feedback = false;
    echo "<table><tr><th>Submitted By</th><th>Training Event ID</th><th>From Date</th><th>To Date</th><th>Training Event Name</th><th>Actions</th></tr>";
    ...
    if (!$has_pending_feedback) {
        echo "<tr><td colspan='3' ><strong style= 'color: red;'>No pending feedback forms.</strong></td></tr>";
    }
    
    echo "</table>";
    ?>

    <h3 class="color1">Past Forms</h3>
    <?php
    ...
    if (!$has_past_feedback) {
        echo "<tr><td colspan='3'><strong style='color: red;'>No past feedback forms.</strong></td></tr>";
    }
