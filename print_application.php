        ...
        <?php if ($application): ?>
            <div class="section">
                ...
                <table class="table">
                    ...
                    <?php if (!empty($application['fax_no'])): ?>
                        <tr>
                            <th>Fax Number:</th>
                            <td><?php echo htmlspecialchars($application['fax_no']); ?></td>
                        </tr>
                    <?php endif; ?>
                    <?php if (!empty($application['date_of_joining'])): ?>
                        <tr>
                            <th>Date of Joining:</th>
                            <td><?php echo htmlspecialchars($application['date_of_joining']); ?></td>
                        </tr>
                    <?php endif; ?>
            ...
            <div class="section">
                <div class="section-header">
                    <h2>C. Additional Information</h2>
                </div>
                <table class="table">
                    <tr>
                    ...
                    <tr>
                        <th>Last Conference Attended:</th>
            ...
            <div class="section">
                <div class="section-header">
                    <h2>D. Application Status</h2>
                </div>
                <p>Your application has been submitted and is awaiting approval.</p>
                <table class="table">
